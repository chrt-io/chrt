...
export { chrtLine, chrtLine as line } from "chrt-line";
export {
  chrtBars as bars,
  chrtBars,
...
export { chrtPoints, chrtPoints as points } from "chrt-points";
export {
  chrtLabel,
  chrtLabels,
  chrtLabel as label,
...
export { chrtMarkers, chrtMarkers as markers } from "chrt-markers";
export {
  chrtGroup,
  chrtGroup as group,
  chrtStack,
...
export { chrtAnnotation, chrtAnnotation as annotation } from "chrt-annotation";
export * as interpolations from "chrt-interpolations";
export { chrtDotPlot, chrtDotPlot as dotPlot } from "chrt-dotplot";
export {
  chrtHorizontalRange,
